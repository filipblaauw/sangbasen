/**
 * chordprojs - Parse and manipulate ChordPro files.
 * @version 0.1.1
 * @link https://github.com/tvdavies/chordprojs#readme
 */
...
function getTranspose(originalKey, targetKey) {
    var originalKeyIdx = notes.indexOf(originalKey);
    var targetKeyIdx = notes.indexOf(targetKey);

    if (originalKeyIdx > -1 && targetKeyIdx > -1) {
        return targetKeyIdx - originalKeyIdx;
    }
...
Chord.prototype.getText = function () {
    ...
    if (this.transposeProperties.targetKey !== null) {
        ...
        transpose = getTranspose(this.transposeProperties.originalKey, this.transposeProperties.targetKey);
    } else {
        // Get the target key from the transpose
        this.transposeProperties.targetKey = chordMagic.prettyPrint(chordMagic.transpose(chordMagic.parse(this.transposeProperties.originalKey), transpose));
    }
